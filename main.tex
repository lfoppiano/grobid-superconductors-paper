...
%Furthermore, we exploit the native information from PDF document provided by Grobid to construct a curation interface for data quality enhancement. 
...
% The superconductors model is available in three architecture: 
%  - uses additional features that are provided by the PDFs
